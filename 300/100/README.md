...
Initiative: **Master Security Engineering**
...
Hence, mastering security engineering has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
